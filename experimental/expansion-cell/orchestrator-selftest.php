...
try{
 ...
 foreach(['ExpansionProtocol.php','CellNode.php','CellLiving.php','CellPerceptionAction.php','CellWorldModel.php','CellEvolutionReadiness.php','CellEvolutionReadinessAdapter.php'] as $f) chk(copy(__DIR__.'/'.$f,$src.'/'.$f),'copy source '.$f);
