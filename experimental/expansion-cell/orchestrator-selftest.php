...
try{
 ...
 foreach(['ExpansionProtocol.php','CellNode.php'] as $f) chk(copy(__DIR__.'/'.$f,$src.'/'.$f),'copy source '.$f);
 foreach(['common.php','bootstrap.php','federation.php','status.php'] as $f) chk(copy(__DIR__.'/cell-runtime/'.$f,$src.'/cell-runtime/'.$f),'copy runtime '.$f);
