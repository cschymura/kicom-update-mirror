...
- test-snapshot-order.php: eleven isolated regression tests for time ordering, same-second ambiguity, duplicate/invalid manifest data and missing integrity evidence. Current total: 32 core + 22 KCL + 13 persistence + 11 snapshot-order = 78 isolated tests.
