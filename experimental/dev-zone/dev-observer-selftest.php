...
try{
 foreach(['dev-api.php','dev-auth.php','dev-expansion.php','DevSession.php','DevExpansionBindings.php','DevSandboxPerception.php','expansion/ExpansionService.php','expansion/ExpansionOrchestrator.php','expansion/ExpansionCellPackageBuilder.php','expansion/ExpansionLocalFilesystemDeployer.php','expansion/ExpansionKiComDeployTargetResolver.php','expansion/cell-runtime/common.php','expansion/cell-runtime/bootstrap.php','expansion/cell-runtime/federation.php','expansion/cell-runtime/status.php'] as $f){$p=$base.'/dev/'.$f;@mkdir(dirname($p),0700,true);file_put_contents($p,'x');}
