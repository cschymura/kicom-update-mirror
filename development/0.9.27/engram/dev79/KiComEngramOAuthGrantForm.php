...
final class KiComEngramOAuthGrantForm
{
    ...
    private const REFRESH_KEYS=['grant_type','refresh_token','client_id','resource'];
    ...
    public static function parse(string $raw,array $trustedClient):array
    {
        ...
        if(($out['client_id']??null)!==$trustedClient['client_id']
           ||($out['resource']??null)!==self::RESOURCE)self::reject();
