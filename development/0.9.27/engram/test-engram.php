...
// Native KiCom route: server-only host gate -> original DEV session -> exact private consent -> fresh-session scoped recall.
require __DIR__ . '/test-engram-native-memory-route.php';
