...
const KICOM_MAX_POST_BYTES = 32768;
...
function kicomCreateIntent(string $operation,string $target): array {
    ...
    $allowed=['STAGE_PROPOSE','WORKSPACE_PROPOSE','WORKSPACE_ROLLBACK','MEMORY_PROPOSE','MEMORY_PATCH_PROPOSE','MEMORY_ROLLBACK','DEPLOY_PROPOSE','DEPLOY_ROLLBACK','DEPLOY_PACKAGE_PROPOSE','DEPLOY_PACKAGE_ROLLBACK'];
...
function kicomValidateContent(string $path, string $content): array {
    ...
    if ($ext === 'php') {
        ...
        return $code === 0 ? ['status'=>'ok','message'=>'PHP_SYNTAX_OK'] : ['status'=>'error','message'=>'PHP_SYNTAX_ERROR'];
    }
