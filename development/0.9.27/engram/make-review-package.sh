...
for file in KiComEngramStore.php KiComEngramIngestionGate.php KiComEngramAuthenticatedBridge.php KiComEngramDevMemoryAdapter.php KiComEngramVerifiedCredentialResolver.php KiComEngramDevSessionCredentialReader.php KiComEngramPrivateOwnerRegistry.php KiComEngramPrivateConsentLedger.php KiComEngramFirstPartyReview.php KiComEngramPrivatePathProbe.php KiComEngramDevPathHandler.php KiComEngramDevCandidatePatcher.php KiComEngramSyntheticTransfer.php; do
  cp -- "development/0.9.27/engram/$file" "$D/source/$file"
done
for file in test-engram-authenticated-bridge.php test-engram-dev-memory-adapter.php test-engram-verified-credential-resolver.php test-engram-dev-session-credential-reader.php test-engram-private-owner-registry.php test-engram-private-consent-ledger.php test-engram-integrated-private-memory.php test-engram-first-party-review.php test-private-path-probe.php test-engram-dev-route.php test-engram-endpoint.php test-engram-offline-transfer.php fixture-engram-trusted-config.php; do
